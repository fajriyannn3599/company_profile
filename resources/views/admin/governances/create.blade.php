...
@section('content')
    <div class="mb-6">
        <div class="flex items-center">
            ...
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Tambah Piagam</h1>
                <p class="mt-1 text-sm text-gray-600">Unggah piagam dalam format PDF</p>
            </div>
        </div>
    </div>

    <div class="max-w-2xl">
        <form action="{{ route('admin.governances.store') }}" method="POST" enctype="multipart/form-data"
            class="space-y-6">
            @csrf
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <label for="title" class="block text-sm font-medium text-gray-700 mb-2">
                            Judul Piagam <span class="text-red-500">*</span>
                        </label>
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="3"
                            ...
                            placeholder="Deskripsi singkat piagam (opsional)">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
