...
@section('content')
    <div class="mb-6">
        <div class="flex items-center">
            ...
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Tambah Proyek</h1>
                <p class="mt-1 text-sm text-gray-600">Buat portofolio proyek baru</p>
            </div>
        </div>
    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                <div class="bg-white shadow-sm border border-gray-200 rounded-lg p-6">
                    ...
                    <div class="space-y-4">
                        <div>
                            <label for="title" class="block text-sm font-medium text-gray-700 mb-2">Judul Proyek <span
                        ...
                        <div>
                            <label for="project_category_id" class="block text-sm font-medium text-gray-700 mb-2">Kategori
                                <span class="text-red-500">*</span></label>
                            <select name="project_category_id" id="project_category_id"
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('project_category_id') border-red-500 @enderror">
                                <option value="">Pilih Kategori</option>
                                @foreach ($categories as $cat)
                                    <option value="{{ $cat->id }}"
                                        {{ old('project_category_id') == $cat->id ? 'selected' : '' }}>{{ $cat->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            <label for="short_description" class="block text-sm font-medium text-gray-700 mb-2">Deskripsi
                                Singkat</label>
                            <textarea name="short_description" id="short_description" rows="2"
                                ...
                                placeholder="Deskripsi singkat proyek">{{ old('short_description') }}</textarea>
                            @error('short_description')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        <div>
                            <label for="description" class="block text-sm font-medium text-gray-700 mb-2">Deskripsi Lengkap
                                <span class="text-red-500">*</span></label>
                            <textarea name="description" id="description" rows="8"
                                ...
                                placeholder="Deskripsi lengkap proyek">{{ old('description') }}</textarea>
            ...
            <div class="space-y-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="url" name="project_url" id="project_url" value="{{ old('project_url') }}"
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('project_url') border-red-500 @enderror"
                                placeholder="https://">
                            @error('project_url')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            <label for="technologies" class="block text-sm font-medium text-gray-700 mb-2">Teknologi yang
                                Digunakan</label>
                        ...
                        <div>
                            <label for="sort_order" class="block text-sm font-medium text-gray-700 mb-2">Urutan
                                Tampil</label>
                ...
                <div class="bg-white shadow-sm border border-gray-200 rounded-lg p-6">
                    ...
                    <div>
                        <label for="gallery" class="block text-sm font-medium text-gray-700 mb-2">Galeri Gambar (bisa
