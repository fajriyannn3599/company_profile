...
@section('content')
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900">{{ $projects->where('is_active', true)->count() }}
                            </dd>
                        </dl>
                    </div>
                </div>
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900">
                                {{ $projects->where('is_featured', true)->count() }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
        ...
        return $project->end_date && $project->end_date->isPast(); })->count() }}
                            </dd>
                        </dl>
                    </div>
                </div>
