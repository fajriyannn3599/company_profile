...
@section('content')
    <div class="py-8">
        <div class="max-w-3xl mx-auto bg-white rounded-lg shadow-md p-6">
            <h2 class="text-xl font-semibold text-gray-800 mb-6">Edit Laporan Keuangan</h2>
            ...
            <form action="{{ route('admin.financial-reports.update', $financialReport->id) }}" method="POST"
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="title" id="title"
                        ...
                        value="{{ old('title', $financialReport->title) }}" required>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <textarea name="description" id="description" rows="4"
                        class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:ring-blue-500 focus:border-blue-500"
                        required>{{ old('description', $financialReport->description) }}</textarea>
                </div>
                ...
                <div class="bg-white shadow-sm border border-gray-200 rounded-lg p-6 mb-6">
                    ...
                    @if ($financialReport->file_url)
                        <div class="mt-4">
                            <p class="text-sm text-gray-600">File saat ini:</p>
                            <a href="{{ $financialReport->file_url }}" target="_blank" class="text-blue-600 underline">
                                Lihat File Saat Ini
                            </a>
                        </div>
                    @endif
