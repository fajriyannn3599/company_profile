...
<div class="mb-6">
    <div class="flex items-center">
        ...
        <div>
            ...
            <p class="mt-1 text-sm text-gray-600">Perbarui data layanan perusahaan</p>
        </div>
    </div>
</div>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="short_description" 
                                  ...
                                  placeholder="Deskripsi singkat untuk preview">{{ old('short_description', $service->short_description) }}</textarea>
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="8" class="summernote w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('description') border-red-500 @enderror" placeholder="Deskripsi lengkap layanan">{{ old('description', $service->description ?? '') }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="meta_description" 
                                  ...
                                  placeholder="Meta description untuk SEO">{{ old('meta_description', $service->meta_description) }}</textarea>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white shadow-sm border border-gray-200 rounded-lg p-6">
                ...
                <div>
                    ...
                    </div>                    @if($service->image)
                        <div class="mt-4 p-4 bg-gray-50 rounded-lg">
                            <p class="text-sm font-medium text-gray-700 mb-2">Gambar Saat Ini:</p>
                            <img src="{{ Storage::url($service->image) }}" alt="Gambar Layanan" class="h-32 w-auto rounded-lg border shadow-sm">
                ...
                <div class="border border-gray-200 rounded-lg p-4 bg-gray-50">
                    <div class="flex items-start space-x-4">
                        ...
                        <div class="flex-1 min-w-0">
                            <h4 id="preview-title" class="text-lg font-medium text-gray-900">{{ $service->title ?? 'Nama Layanan' }}</h4>
                            <p id="preview-description" class="text-sm text-gray-600 mt-1">{{ $service->short_description ?? 'Deskripsi singkat layanan akan muncul di sini...' }}</p>
                            <div class="mt-2">
                                <span id="preview-price" class="text-sm font-medium text-blue-600">{{ $service->price_range ?? 'Hubungi untuk harga' }}</span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    document.getElementById('image').addEventListener('change', function(e) {
        ...
        if (file) {
            ...
            reader.onload = function(e) {
                ...
                preview.innerHTML = `
                    <p class="text-sm font-medium text-blue-700 mb-2">Preview Gambar Baru:</p>
