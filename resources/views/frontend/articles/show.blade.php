    ...
    <section class="bg-gradient-to-br from-red-50 to-red-100 py-16">
        <div class="container mx-auto px-4">
            <div class="max-w-4xl mx-auto">
                ...
                <h1 class="text-4xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight text-center"
                    style="font-family: 'Poppins', sans-serif;">
                    {{ $article->title }}
                </h1>

                @if ($article->featured_image)
                    <div class="flex justify-center items-center w-full" style="font-family: 'Poppins', sans-serif;">
                        <div class="aspect-video lg:aspect-square overflow-hidden w-[70vh] h-[50vh]">
                ...
                @if ($article->excerpt)
                    <p class="text-xl text-gray-600 mb-8 leading-relaxed text-center"
                        style="font-family: 'Poppins', sans-serif;">
                        {{ $article->excerpt }}
                    </p>
                @endif
                ...
                <div class="flex items-center justify-between flex-wrap gap-4">
                    <div class="flex items-center gap-6">
                        ...
                        <div class="text-sm text-gray-600" style="font-family: 'Poppins', sans-serif;">
            ...
            <div class="container mx-auto px-4">
                <div class="max-w-5xl mx-auto">
                    <div class="rounded-2xl overflow-hidden shadow-2xl">
                        <img src="{{ Storage::url($article->featured_image) }}" alt="{{ $article->title }} style="
                            font-family: 'Poppins' , sans-serif;"" class="w-full h-auto object-cover">
                    </div>
                </div>
            </div>
        </section>
                        ...
                        @foreach ($relatedArticles as $relatedArticle)
                            <article
                                ...
                                <div class="p-6" style="font-family:'Poppins', sans-serif;">
                                    ...
                                    <h3 class="text-xl font-bold text-gray-900 mb-3 hover:text-red-600 transition-colors line-clamp-2"
                                        style="font-family:'Poppins', sans-serif;">
