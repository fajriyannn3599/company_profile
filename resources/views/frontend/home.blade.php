...
@section('content')
                    ...
                    <div class="swiper-slide h-full">
                        <a href="#">
                            <img src="{{ asset('images/slides/1.jpg') }}"
                                class="w-full h-full object-contain sm:object-cover object-center" alt="Slide 1">
                        </a>
                    </div>
                    ...
                    <div class="swiper-slide h-full">
                        <a href="#">
                            <img src="{{ asset('images/slides/2.jpg') }}"
                                class="w-full h-full object-contain sm:object-cover object-center" alt="Slide 2">
                        </a>
                    </div>
                    ...
                    <div class="swiper-slide h-full">
                        <a href="#">
                            <img src="{{ asset('images/slides/3.jpg') }}"
                                class="w-full h-full object-contain sm:object-cover object-center" alt="Slide 3">
                        </a>
                    </div>
                </div>
    ...
    @if ($service_categories->count() > 0)
        <section class="py-20 bg-gradient-to-br from-gray-50 to-blue-50 justify-items-center">
