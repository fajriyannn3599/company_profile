...
@push('seo')
    <x-seo-head page-identifier="about" :title="page_title('about', 'Tentang Kami - ' . setting('site_name'))"
...
@section('content')
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
                <div class="space-y-8">
                    <div>
                        ...
                        <div class="w-24 h-1 bg-gradient-to-r from-red-600 to-yellow-600 rounded-full mb-8"></div>
                    </div>
                ...
                <div class="relative">
                    <div
                        class="absolute -inset-4 bg-gradient-to-r from-yellow-600 to-red-600 blur opacity-20 float-animation">
                    </div>
    ...
    <section class="py-20 relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                <!-- Vision -->
                <div class="card-hover bg-white shadow-xl p-10 relative overflow-hidden">
                    <div
    ...
    @if($teams->count() > 0)
        <section class="py-20 bg-gradient-to-br from-gray-50 to-white relative overflow-hidden">
            <!-- Background Elements -->
            <div class="absolute top-0 left-0 w-96 h-96 bg-blue-100 rounded-full -translate-x-48 -translate-y-48 opacity-30">
            </div>
            <div
                class="absolute bottom-0 right-0 w-96 h-96 bg-purple-100 rounded-full translate-x-48 translate-y-48 opacity-30">
            </div>
                            ...
                            @else
                                <div class="w-full h-64 bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center">
                                    <div class="text-center">
                                        ...
                                        <p class="text-gray-500 text-sm" style="font-family: 'Poppins', sans-serif;">Foto Tim</p>
                                    </div>
                                </div>
                            @endif
